...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      AJ: (x0,x1) => { x0.binaryType = x1 },
      AK: (x0,x1) => { x0.nonce = x1 },
      ...
      BJ: x0 => new BroadcastChannel(x0),
      BK: (x0,x1) => x0.querySelectorAll(x1),
      ...
      GJ: (x0,x1,x2) => x0.insertBefore(x1,x2),
      GK: (x0,x1) => { x0.src = x1 },
      ...
      IJ: x0 => x0.offsetHeight,
      IK: (x0,x1) => { x0.defer = x1 },
      ...
      JI: (x0,x1) => x0.get(x1),
      JJ: x0 => x0.offsetWidth,
      JK: (x0,x1) => { x0.async = x1 },
      K: (exn) => {
      ...
      PI: x0 => x0.status,
      PJ: (x0,x1) => { x0.scrollLeft = x1 },
      PK: x0 => { globalThis.onGoogleLibraryLoad = x0 },
      ...
      QI: x0 => x0.getReader(),
      QJ: (x0,x1) => { x0.spellcheck = x1 },
      QK: (x0,x1,x2) => x0.setAttribute(x1,x2),
      ...
      YH: () => globalThis.Intl,
      YI: x0 => x0.abort(),
      YJ: x0 => x0.rasterEndMilliseconds,
      YK: x0 => x0.body,
      Z: (o0, o1, o2) => [o0, o1, o2],
      ...
      ZJ: x0 => x0.rasterStartMilliseconds,
      ZK: (x0,x1) => new OffscreenCanvas(x0,x1),
      ...
      fH: x0 => x0.iterator,
      fI: (x0,x1,x2,x3) => x0.replaceState(x1,x2,x3),
      fJ: x0 => x0.metaKey,
      ...
      vI: (x0,x1,x2) => x0.close(x1,x2),
      vJ: x0 => ({createScriptURL: x0}),
      ...
      wI: (x0,x1) => x0.close(x1),
      wJ: (x0,x1,x2) => x0.createPolicy(x1,x2),
      ...
      xH: () => Date.now(),
      xI: x0 => x0.close(),
      xJ: (x0,x1) => x0.createScriptURL(x1),
